...
em que $T_i$ e $Q_i$ são o empuxo e o torque de reação do $i$-ésimo rotor, obtidos do comando $\sigma_i$ pelo modelo de motor do Capítulo~\ref{chap:modelagem}. A entrada efetivamente analisada na avaliação da manobra é o momento $\tau$ do eixo excitado, e não o PWM bruto nem o comando do piloto.
...
Essa inspeção visual, contudo, constitui apenas uma triagem preliminar. A verificação quantitativa da qualidade dos dados é realizada {\color{blue}na Seção~\ref{sec:coerencia}}, no qual cada janela é avaliada pelos critérios numéricos de conteúdo em frequência, relação sinal-ruído e isolamento entre eixos, com os resultados reunidos em tabelas, incluindo a menor autoridade do canal de guinada, quantificada ali.
...
\section{Verificação da Coerência de Dados de Entrada}\label{sec:coerencia}
